# Project Pulse – AI Code Guide

Note: This document is intended as a guide for AI-assisted coding, providing context, guidelines, and requirements for agent code generation.
...
1. `/requirements/web-tech-project.md`
2. `/requirements/use-cases.md`
3. `/requirements/project-glossary.md`
...
- ALWAYS check `/docs/decisions/` before changing architecture
